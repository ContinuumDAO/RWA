...
const RECEIVER_MAGIC_VALUE = "0xeaf93d54"; // bytes4(keccak256("onCTMRWA001Received(address,uint256,uint256,uint256,bytes)"))


function shouldBehaveLikeCTMRWA001 (errorPrefix) {
  ...
  context('with minted tokens', function () {
    ...
    beforeEach(async function () {
      ...
      this.toWhom = other;
      this.CTMRWA001ReceiverMockFactory = await ethers.getContractFactory('CTMRWA001ReceiverMock');
    ...
    describe('balanceOf(uint256)', function () {
      ...
      context('when the given token does not exist', function () {
        it('reverts', async function () {
          await expect(this.token['balanceOf(uint256)'](0)).to.be.revertedWith('CTMRWA001: invalid token ID');
          await expect(this.token['balanceOf(uint256)'](nonExistentTokenId)).to.be.revertedWith('CTMRWA001: invalid token ID');
        });
      });
    });
    ...
    describe('slotOf', function () {
      ...
      context('when the given token does not exist', function () {
        it('reverts', async function () {
          await expect(this.token.slotOf(0)).to.be.revertedWith('CTMRWA001: invalid token ID');
          await expect(this.token.slotOf(nonExistentTokenId)).to.be.revertedWith('CTMRWA001: invalid token ID');
        });
      });
    });
    ...
    describe('transfer value from token to token', function () {
      ...
      const shouldTransferValueFromTokenToTokenByUsers = function () {
        ...
        context('when transfer value exceeds balance of token', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTMRWA001: insufficient balance for transfer');
          });
        });
        ...
        context('when transfer to a token with different slot', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTMRWA001: transfer to token with different slot');
          });
        });
        ...
        context('with invalid token ID', function() {
          it('reverts when from token ID is invalid', async function() {
            ...
            ).to.be.revertedWith('CTMRWA001: invalid token ID');
          });
          ...
          it('reverts when to token ID is invalid', async function() {
            ...
            ).to.be.revertedWith('CTMRWA001: transfer to invalid token ID');
          });
        });
        ...
        context('when the sender is not authorized for the token id', function () {
          it('reverts', async function () {
            ...
            ).to.revertedWith('CTMRWA001: insufficient allowance');
          });
        });
        ...
        context('when transfer value exceeds allowance', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTMRWA001: insufficient allowance');
          });
        });
      };
      ...
      const deployReceiverAndMint = async function (magicValue, errorType) {
        this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy(magicValue, errorType);
        this.toTokenId = 1003;
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: transfer rejected by CTMRWA001Receiver');
        });
      });
      ...
      describe('to a receiver contract that reverts with message', function () {
        it('reverts', async function () {
          ...
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,uint256,uint256)'](this.fromTokenId, this.toTokenId, transferValue)
          ).to.revertedWith('CTMRWA001ReceiverMock: reverting');
        });
      });
    ...
    describe('transfer value from token to address', function () {
      ...
      const shouldTransferValueFromTokenToAddressByUsers = function () {
        ...
        context('transfer to the zero address', function() {
          it('reverts', async function() {
            ...
            ).to.be.revertedWith('CTMRWA001: mint to the zero address');
          });
        });
      ...
      describe('to a valid receiver contract', function () {
        beforeEach(async function () {
          this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.None);
          this.toOwnerBalance = await this.token['balanceOf(address)'](this.toOwner.address);
        });
        shouldTransferValueFromTokenToAddressByUsers();
      });
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy('0x12345678', Error.None);
          await expect(
      ...
      describe('to a receiver contract that reverts with message', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.RevertWithMessage);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.revertedWith('CTMRWA001ReceiverMock: reverting');
        });
      ...
      describe('to a receiver contract that reverts without message', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.RevertWithoutMessage);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.reverted;
        });
      ...
      describe('to a receiver contract that panics', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTMRWA001ReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.Panic);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.revertedWithPanic;
        });
    ...
    describe('approve value', function () {
      ...
      context('when the address that receives the allowance is the owner', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: approval to current owner');
        });
      });
      ...
      context('when the sender does not own the given token ID', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: approve caller is not owner nor approved');
        });
      });
      ...
      context('when then given token ID does not exist', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: invalid token ID');
        });
      });
      ...
      context('when set allowance to the zero address', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: approve value to the zero address');
        });
      });
  ...
  describe('_mint', function () {
    it('reverts with an invalid token ID', async function () {
      ...
      ).to.revertedWith('CTMRWA001: cannot mint zero tokenId');
    });
    ...
    context('with minted tokens', function () {
      ...
      context('with burnt token', function () {
        ...
        it('deletes the token', async function () {
          ...
          await expect(this.token.ownerOf(firstTokenId)).to.revertedWith('CTMRWA001: invalid token ID');
          await expect(this.token.slotOf(firstTokenId)).to.revertedWith('CTMRWA001: invalid token ID');
          await expect(this.token.getApproved(firstTokenId)).to.revertedWith('CTMRWA001: invalid token ID');
          await expect(this.token.allowance(firstTokenId, valueApproved.address)).to.revertedWith('CTMRWA001: invalid token ID');
        });
  ...
  describe('_burnValue', function () {
    ...
    context('with minted tokens', function () {
      ...
      it('reverts when burn value exceeds balance', async function () {
        ...
        ).to.revertedWith('CTMRWA001: burn value exceeds balance');
      });
    });
  });
}

function shouldBehaveLikeCTMRWA001Metadata (errorPrefix) {
  shouldSupportInterfaces([
    'ERC721Metadata',
    'CTMRWA001Metadata'
  ]);
...
function shouldBehaveLikeCTMRWA001SlotEnumerable (errorPrefix) {
  shouldSupportInterfaces([
  ...
  context('with minted tokens', function () {
    ...
    describe('slot by index', function () {
      ...
      it('reverts if index is greater than slot count', async function () {
        ...
        ).to.revertedWith('CTMRWA001SlotEnumerable: slot index out of bounds')
      });
    });
    ...
    describe('tokenInSlotByIndex', function () {
      ...
      context('when the given index is greater than or equal to the total tokens in the given slot', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001SlotEnumerable: slot token index out of bounds');
        });
      });
...
function shouldBehaveLikeCTMRWA001SlotApprovable (errorPrefix) {
  shouldSupportInterfaces([
  ...
  describe('setApprovalForSlot', function () {
      ...
      context('after being set as slot operator', function () {
        ...
        context('when approving tokens by the slot operator', function () {
          ...
          it('reverts when approving others tokens in the same slot', async function () {
            ...
            ).to.revertedWith('CTMRWA001: approve caller is not owner nor approved for all/slot');
          });
        ...
        context('when transferring tokens by the slot operator', function () {
          ...
          it('reverts when transferring others tokens in the same slot', async function () {
            ...
            ).to.revertedWith('CTMRWA001: transfer caller is not owner nor approved');
          });
    ...
    context('when slot operator is the owner', function () {
      it('reverts', async function () {
        ...
        ).to.revertedWith('CTMRWA001SlotApprovable: approve to owner');
      });
    });
    ...
    context('when slot operator is set not by the owner', function () {
      ...
      it('reverts when set by token approved user', async function () {
        ...
        ).to.revertedWith('CTMRWA001SlotApprovable: caller is not owner nor approved for all');
      });
...
function shouldBehaveLikeCTMRWA001BasicToken (errorPrefix) {
  shouldSupportInterfaces([
    'CTMRWA001SlotApprovable',
  ]);
...
module.exports = {
  ...
  shouldBehaveLikeCTMRWA001BasicToken
}
