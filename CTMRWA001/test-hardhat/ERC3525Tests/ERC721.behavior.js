...
function shouldBehaveLikeERC721 (errorPrefix) {
    ...
    describe('balanceOf(address)', function () {
      ...
      context('when querying the zero address', function () {
        it('throws', async function () {
          await expect(this.token['balanceOf(address)'](ZERO_ADDRESS)).to.revertedWith('CTMRWA001: balance query for the zero address');
        });
      });
    });
    ...
    describe('ownerOf', function () {
      ...
      context('when the given token ID was not tracked by this token', function () {
        it('reverts', async function () {
          await expect(this.token.ownerOf(nonExistentTokenId)).to.revertedWith('CTMRWA001: invalid token ID');
        });
      });
    });
      ...
      const shouldTransferTokensByUsers = function (transferFunction) {
        ...
        context('when the address of the previous owner is incorrect', function () {
          it('reverts', async function () {
            ...
            ).to.revertedWith('CTMRWA001: transfer from invalid owner');
          });
        });
        ...
        context('when the address to transfer the token to is the zero address', function () {
          it('reverts', async function () {
            ...
            ).to.revertedWith('CTMRWA001: transfer to the zero address');
          });
        });
      };
      ...
      describe('via safeTransferFrom', function () {
        ...
        describe('to a receiver contract returning unexpected value', function () {
          it('reverts', async function () {
            ...
            ).to.revertedWith('CTMRWA001: transfer to non ERC721Receiver');
          });
        });
    ...
    describe('approve', function () {
      ...
      context('when the sender does not own the given token ID', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: approve caller is not owner nor approved for all');
        });
      });
    ...
    describe('setApprovalForAll', function () {
      ...
      context('when the operator is the owner', function () {
        it('reverts', async function () {
          ...
          ).to.rejectedWith('CTMRWA001: approve to caller');
        });
      });
    });
    ...
    describe('getApproved', async function () {
      context('when token is not minted', async function () {
        it('reverts', async function () {
          ...
          ).to.rejectedWith('CTMRWA001: invalid token ID');
        });
      });
  ...
  describe('_mint', function () {
    it('reverts with a null destination address', async function () {
      ...
      ).to.revertedWith('CTMRWA001: mint to the zero address');
    });
    ...
    context('with minted token', async function () {
      ...
      it('reverts when adding a token id that already exists', async function () {
        ...
        ).to.revertedWith('CTMRWA001: token already minted');
      });
    });
  });
  ...
  context('with minted tokens', function () {
    ...
    describe('tokenOfOwnerByIndex', function () {
      ...
      describe('when the index is greater than or equal to the total tokens owned by the given address', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTMRWA001: owner index out of bounds');
        });
      });
    ...
    describe('tokenByIndex', function () {
      ...
      it('reverts if index is greater than supply', async function () {
        ...
        ).to.revertedWith('CTMRWA001: global index out of bounds');
      });
