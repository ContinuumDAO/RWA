...
export interface ERC3525SlotApprovableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525SlotApprovable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525SlotApprovableInterface;
