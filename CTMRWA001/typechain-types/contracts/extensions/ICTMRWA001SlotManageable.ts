...
export interface ICTMRWA001SlotManageableInterface extends utils.Interface {
  functions: {
...
export interface ICTMRWA001SlotManageable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001SlotManageableInterface;
