...
export interface ICTMRWA001SlotApprovableInterface extends utils.Interface {
  functions: {
...
export interface ICTMRWA001SlotApprovable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001SlotApprovableInterface;
