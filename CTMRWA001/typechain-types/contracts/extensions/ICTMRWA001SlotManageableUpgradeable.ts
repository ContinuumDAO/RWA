...
export interface ICTMRWA001SlotManageableUpgradeableInterface
  ...
  functions: {
    ...
    "managerOfSlot(uint256)": FunctionFragment;
    "ownerOf(uint256)": FunctionFragment;
    "safeTransferFrom(address,address,uint256)": FunctionFragment;
    "safeTransferFrom(address,address,uint256,bytes)": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "slotCountOfManager(address)": FunctionFragment;
    "slotOf(uint256)": FunctionFragment;
    "slotOfManagerByIndex(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "managerOfSlot",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "slotCountOfManager",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "slotOfManagerByIndex",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface ICTMRWA001SlotManageableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001SlotManageableUpgradeableInterface;
