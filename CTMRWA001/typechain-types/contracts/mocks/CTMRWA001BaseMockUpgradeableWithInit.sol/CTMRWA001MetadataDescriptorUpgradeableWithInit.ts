...
export interface CTMRWA001MetadataDescriptorUpgradeableWithInitInterface
...
export interface CTMRWA001MetadataDescriptorUpgradeableWithInit
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001MetadataDescriptorUpgradeableWithInitInterface;
