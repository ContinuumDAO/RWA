...
export interface CTMRWA001BaseMockUpgradeableWithInitInterface
...
export interface CTMRWA001BaseMockUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001BaseMockUpgradeableWithInitInterface;
