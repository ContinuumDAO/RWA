...
export interface CTMRWA001BaseMockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001BaseMockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001BaseMockUpgradeableInterface;
