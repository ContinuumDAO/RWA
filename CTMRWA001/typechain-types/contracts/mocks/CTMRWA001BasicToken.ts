...
export interface CTMRWA001BasicTokenInterface extends utils.Interface {
  functions: {
    "ID()": FunctionFragment;
...
export interface CTMRWA001BasicToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001BasicTokenInterface;
