...
export interface ERC3525AllRoundMockUpgradeableInterface
...
export interface ERC3525AllRoundMockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525AllRoundMockUpgradeableInterface;
