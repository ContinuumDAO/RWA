...
export interface CTM3525XAllRoundMockUpgradeableWithInitInterface
...
export interface CTM3525XAllRoundMockUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XAllRoundMockUpgradeableWithInitInterface;
