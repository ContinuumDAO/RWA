...
export interface CTMRWA001SlotEnumerableInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001SlotEnumerable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001SlotEnumerableInterface;
