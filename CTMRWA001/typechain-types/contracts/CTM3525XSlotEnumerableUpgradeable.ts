...
export interface CTM3525XSlotEnumerableUpgradeableInterface
...
export interface CTM3525XSlotEnumerableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XSlotEnumerableUpgradeableInterface;
