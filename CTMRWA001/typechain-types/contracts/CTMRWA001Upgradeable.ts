...
export interface CTMRWA001UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001UpgradeableInterface;
