...
export interface CTM3525XMintableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XMintableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XMintableUpgradeableInterface;
