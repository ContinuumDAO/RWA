...
export interface CTMRWA001DeployerInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001Deployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001DeployerInterface;
