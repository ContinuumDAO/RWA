...
export interface CTMRWA001MetadataDescriptorInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001MetadataDescriptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001MetadataDescriptorInterface;
