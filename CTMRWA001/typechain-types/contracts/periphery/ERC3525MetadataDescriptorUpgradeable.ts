...
export interface ERC3525MetadataDescriptorUpgradeableInterface
...
export interface ERC3525MetadataDescriptorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525MetadataDescriptorUpgradeableInterface;
