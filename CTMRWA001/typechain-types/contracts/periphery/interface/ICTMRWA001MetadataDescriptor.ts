...
export interface ICTMRWA001MetadataDescriptorInterface extends utils.Interface {
  functions: {
...
export interface ICTMRWA001MetadataDescriptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001MetadataDescriptorInterface;
