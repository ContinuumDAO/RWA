...
export interface ICTMRWA001MetadataDescriptorUpgradeableInterface
...
export interface ICTMRWA001MetadataDescriptorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001MetadataDescriptorUpgradeableInterface;
