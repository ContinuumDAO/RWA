...
export interface CTMRWA001BurnableInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001Burnable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001BurnableInterface;
