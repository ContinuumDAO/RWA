...
export interface ERC3525UpgradeableWithInitInterface extends utils.Interface {
  functions: {
...
export interface ERC3525UpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525UpgradeableWithInitInterface;
