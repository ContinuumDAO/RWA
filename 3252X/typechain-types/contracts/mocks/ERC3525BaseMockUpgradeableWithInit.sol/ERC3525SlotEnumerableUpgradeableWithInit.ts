...
export interface ERC3525SlotEnumerableUpgradeableWithInitInterface
...
export interface ERC3525SlotEnumerableUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525SlotEnumerableUpgradeableWithInitInterface;
