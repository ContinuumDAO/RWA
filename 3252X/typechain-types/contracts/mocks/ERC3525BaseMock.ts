...
export interface ERC3525BaseMockInterface extends utils.Interface {
  functions: {
...
export interface ERC3525BaseMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525BaseMockInterface;
