...
export interface ERC3525AllRoundMockInterface extends utils.Interface {
  functions: {
...
export interface ERC3525AllRoundMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525AllRoundMockInterface;
