...
export interface ERC3525BurnableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525BurnableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525BurnableUpgradeableInterface;
