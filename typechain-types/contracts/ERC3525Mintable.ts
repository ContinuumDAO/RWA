...
export interface ERC3525MintableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525Mintable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525MintableInterface;
