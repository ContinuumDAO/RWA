...
export interface CTMRWA001MintableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTMRWA001MintableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001MintableUpgradeableInterface;
