...
export interface CTM3525XUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XUpgradeableInterface;
