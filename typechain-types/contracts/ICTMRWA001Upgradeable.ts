...
export interface ICTMRWA001UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ICTMRWA001Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTMRWA001UpgradeableInterface;
