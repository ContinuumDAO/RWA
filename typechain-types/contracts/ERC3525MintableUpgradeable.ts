...
export interface ERC3525MintableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525MintableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525MintableUpgradeableInterface;
