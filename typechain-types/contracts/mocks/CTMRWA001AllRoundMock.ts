...
export interface CTMRWA001AllRoundMockInterface extends utils.Interface {
  functions: {
    "ID()": FunctionFragment;
...
export interface CTMRWA001AllRoundMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001AllRoundMockInterface;
