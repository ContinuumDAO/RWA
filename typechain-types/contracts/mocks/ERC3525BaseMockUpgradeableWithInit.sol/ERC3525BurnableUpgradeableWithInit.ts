...
export interface ERC3525BurnableUpgradeableWithInitInterface
...
export interface ERC3525BurnableUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525BurnableUpgradeableWithInitInterface;
