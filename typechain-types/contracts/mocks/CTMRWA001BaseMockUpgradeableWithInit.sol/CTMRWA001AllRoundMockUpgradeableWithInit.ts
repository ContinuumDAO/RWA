...
export interface CTMRWA001AllRoundMockUpgradeableWithInitInterface
  ...
  encodeFunctionData(
    functionFragment: "isApprovedForSlot",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>
...
export interface ApprovalForSlotEventObject {
  _owner: string;
  _slot: BigNumber;
  _operator: string;
  _approved: boolean;
}
export type ApprovalForSlotEvent = TypedEvent<
  [string, BigNumber, string, boolean],
  ApprovalForSlotEventObject
>;

export type ApprovalForSlotEventFilter = TypedEventFilter<ApprovalForSlotEvent>;
...
export interface CTMRWA001AllRoundMockUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001AllRoundMockUpgradeableWithInitInterface;
  ...
  functions: {
    ...
    burnValue(
      tokenId_: PromiseOrValue<BigNumberish>,
      burnValue_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ApprovalForSlot(address,uint256,address,bool)"(
      _owner?: PromiseOrValue<string> | null,
      _slot?: PromiseOrValue<BigNumberish> | null,
      _operator?: PromiseOrValue<string> | null,
      _approved?: null
    ): ApprovalForSlotEventFilter;
    ApprovalForSlot(
      _owner?: PromiseOrValue<string> | null,
      _slot?: PromiseOrValue<BigNumberish> | null,
      _operator?: PromiseOrValue<string> | null,
