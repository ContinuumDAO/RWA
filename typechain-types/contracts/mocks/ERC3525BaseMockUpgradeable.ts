...
export interface ERC3525BaseMockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525BaseMockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525BaseMockUpgradeableInterface;
