...
export interface ERC3525ReceiverMockInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "onERC3525Received" | "supportsInterface"
  ): FunctionFragment;
...
export interface ERC3525ReceiverMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525ReceiverMockInterface;
