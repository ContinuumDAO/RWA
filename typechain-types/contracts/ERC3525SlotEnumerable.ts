...
export interface ERC3525SlotEnumerableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525SlotEnumerable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525SlotEnumerableInterface;
