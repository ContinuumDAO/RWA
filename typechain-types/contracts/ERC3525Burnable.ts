...
export interface ERC3525BurnableInterface extends utils.Interface {
  functions: {
...
export interface ERC3525Burnable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC3525BurnableInterface;
