...
export interface CTMRWA001MetadataDescriptorUpgradeableInterface
...
export interface CTMRWA001MetadataDescriptorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTMRWA001MetadataDescriptorUpgradeableInterface;
