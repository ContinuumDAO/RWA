...
contract CTMRWA1StorageUtilsTest is Helpers {
    ...
    function _createAddURIXTestData(
        ...
        addURIXSelector = bytes4(keccak256("addURIX(uint256,uint256,string[],uint8[],uint8[],string[],uint256[],uint256[],bytes32[])"));
        ...
        string memory documentData = string.concat(_title, " - Property Portfolio: 123 Main St, 456 Oak Ave, 789 Pine Blvd");
