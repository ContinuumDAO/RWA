...
import "./CTM3525X.sol";
import "./extensions/ICTM3525XSlotEnumerable.sol";

contract CTM3525XSlotEnumerable is Context, CTM3525X, ICTM3525XSlotEnumerable {
    constructor(
        string memory name_,
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, CTM3525X) returns (bool) {
        return
            interfaceId == type(ICTM3525XSlotEnumerable).interfaceId ||
    ...
    function slotByIndex(uint256 index_) public view virtual override returns (uint256) {
        require(index_ < CTM3525XSlotEnumerable.slotCount(), "CTM3525XSlotEnumerable: slot index out of bounds");
    ...
    function tokenInSlotByIndex(uint256 slot_, uint256 index_) public view virtual override returns (uint256) {
        require(index_ < CTM3525XSlotEnumerable.tokenSupplyInSlot(slot_), "CTM3525XSlotEnumerable: slot token index out of bounds");
