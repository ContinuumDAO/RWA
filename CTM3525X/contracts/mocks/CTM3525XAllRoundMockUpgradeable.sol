...
contract CTM3525XAllRoundMockUpgradeable is Initializable, ContextUpgradeable, CTM3525XSlotApprovableUpgradeable {

    function __CTM3525XAllRoundMock_init(string memory name_, string memory symbol_, uint8 decimals_) internal onlyInitializing {
        __CTM3525X_init_unchained(name_, symbol_, decimals_);
        __CTM3525XSlotEnumerable_init_unchained(name_, symbol_, decimals_);
        __CTM3525XSlotApprovable_init_unchained(name_, symbol_, decimals_);
    }

    function __CTM3525XAllRoundMock_init_unchained(string memory, string memory, uint8) internal onlyInitializing {
    }
