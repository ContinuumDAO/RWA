 ...
 */
interface ICTM3525XUpgradeable is IERC165, IERC721Upgradeable {
    /**
     ...
     *  `_to` is capable of receiving CTM3525X tokens.
     * @dev This function MUST create a new CTM3525X token with the same slot for `_to` to receive
