 ...
 */
interface ICTM3525XReceiverUpgradeable {
    /**
     ...
     *  MUST return 0x009ce20b (i.e. `bytes4(keccak256('onCTM3525XReceived(address,uint256,uint256,
     ...
     * @return `bytes4(keccak256('onCTM3525XReceived(address,uint256,uint256,uint256,bytes)'))` 
     *  unless the transfer is rejected.
     */
    function onCTM3525XReceived(address _operator, uint256 _fromTokenId, uint256 _toTokenId, uint256 _value, bytes calldata _data) external returns (bytes4);
