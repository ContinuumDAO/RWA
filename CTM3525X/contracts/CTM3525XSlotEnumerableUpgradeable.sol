...
import "./extensions/ICTM3525XSlotEnumerableUpgradeable.sol";
import {Initializable} from "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract CTM3525XSlotEnumerableUpgradeable is Initializable, ContextUpgradeable, CTM3525XUpgradeable, ICTM3525XSlotEnumerableUpgradeable {
    function __CTM3525XSlotEnumerable_init(
        string memory name_,
    ...
    function __CTM3525XSlotEnumerable_init_unchained(
        string memory,
        string memory,
        uint8
    ) internal onlyInitializing {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, CTM3525XUpgradeable) returns (bool) {
        return
            interfaceId == type(ICTM3525XSlotEnumerableUpgradeable).interfaceId ||
    ...
    function slotByIndex(uint256 index_) public view virtual override returns (uint256) {
        require(index_ < CTM3525XSlotEnumerableUpgradeable.slotCount(), "CTM3525XSlotEnumerable: slot index out of bounds");
    ...
    function tokenInSlotByIndex(uint256 slot_, uint256 index_) public view virtual override returns (uint256) {
        require(index_ < CTM3525XSlotEnumerableUpgradeable.tokenSupplyInSlot(slot_), "CTM3525XSlotEnumerable: slot token index out of bounds");
    ...
    function _createSlot(uint256 slot_) internal virtual {
        require(!_slotExists(slot_), "CTM3525XSlotEnumerable: slot already exists");
