...
contract CTM3525XBurnableUpgradeable is Initializable, ContextUpgradeable, CTM3525XMintableUpgradeable {

    function __CTM3525XBurnable_init(
        string memory name_,
        string memory symbol_,
        uint8 decimals_
    ) internal onlyInitializing {
        __CTM3525X_init_unchained(name_, symbol_, decimals_);
        __CTM3525XMintable_init_unchained(name_, symbol_, decimals_);
    }

    function __CTM3525XBurnable_init_unchained(
        string memory,
        string memory,
        uint8
    ) internal onlyInitializing {
