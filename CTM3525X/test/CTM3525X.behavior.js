...
// const RECEIVER_MAGIC_VALUE = '0x009ce20b'; // bytes4(keccak256("onERC3525Received(address,uint256,uint256,uint256,bytes)"))
const RECEIVER_MAGIC_VALUE = "0x0f4e93f8"; // bytes4(keccak256("onCTM3525XReceived(address,uint256,uint256,uint256,bytes)"))

let firstOwner, secondOwner, newOwner, approved, valueApproved, anotherApproved, operator, slotOperator, other

function shouldBehaveLikeCTM3525X (errorPrefix) {
  ...
  context('with minted tokens', function () {
    ...
    beforeEach(async function () {
      ...
      this.toWhom = other;
      this.CTM3525XReceiverMockFactory = await ethers.getContractFactory('CTM3525XReceiverMock');
    ...
    describe('balanceOf(uint256)', function () {
      ...
      context('when the given token does not exist', function () {
        it('reverts', async function () {
          await expect(this.token['balanceOf(uint256)'](0)).to.be.revertedWith('CTM3525X: invalid token ID');
          await expect(this.token['balanceOf(uint256)'](nonExistentTokenId)).to.be.revertedWith('CTM3525X: invalid token ID');
        });
      });
    });
    ...
    describe('slotOf', function () {
      ...
      context('when the given token does not exist', function () {
        it('reverts', async function () {
          await expect(this.token.slotOf(0)).to.be.revertedWith('CTM3525X: invalid token ID');
          await expect(this.token.slotOf(nonExistentTokenId)).to.be.revertedWith('CTM3525X: invalid token ID');
        });
      });
    });
    ...
    describe('transfer value from token to token', function () {
      ...
      const shouldTransferValueFromTokenToTokenByUsers = function () {
        ...
        context('when transfer value exceeds balance of token', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTM3525X: insufficient balance for transfer');
          });
        });
        ...
        context('when transfer to a token with different slot', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTM3525X: transfer to token with different slot');
          });
        });
        ...
        context('with invalid token ID', function() {
          it('reverts when from token ID is invalid', async function() {
            ...
            ).to.be.revertedWith('CTM3525X: invalid token ID');
          });
          ...
          it('reverts when to token ID is invalid', async function() {
            ...
            ).to.be.revertedWith('CTM3525X: transfer to invalid token ID');
          });
        });
        ...
        context('when the sender is not authorized for the token id', function () {
          it('reverts', async function () {
            ...
            ).to.revertedWith('CTM3525X: insufficient allowance');
          });
        });
        ...
        context('when transfer value exceeds allowance', function () {
          it('reverts', async function () {
            ...
            ).to.be.revertedWith('CTM3525X: insufficient allowance');
          });
        });
      };
      ...
      const deployReceiverAndMint = async function (magicValue, errorType) {
        this.toOwner = await this.CTM3525XReceiverMockFactory.deploy(magicValue, errorType);
        this.toTokenId = 1003;
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525X: transfer rejected by CTM3525XReceiver');
        });
      });
      ...
      describe('to a receiver contract that reverts with message', function () {
        it('reverts', async function () {
          ...
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,uint256,uint256)'](this.fromTokenId, this.toTokenId, transferValue)
          ).to.revertedWith('CTM3525XReceiverMock: reverting');
        });
      });
    ...
    describe('transfer value from token to address', function () {
      ...
      const shouldTransferValueFromTokenToAddressByUsers = function () {
        ...
        context('transfer to the zero address', function() {
          it('reverts', async function() {
            ...
            ).to.be.revertedWith('CTM3525X: mint to the zero address');
          });
        });
      ...
      describe('to a valid receiver contract', function () {
        beforeEach(async function () {
          this.toOwner = await this.CTM3525XReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.None);
          this.toOwnerBalance = await this.token['balanceOf(address)'](this.toOwner.address);
        });
        shouldTransferValueFromTokenToAddressByUsers();
      });
      ...
      describe('to a receiver contract returning unexpected value', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTM3525XReceiverMockFactory.deploy('0x12345678', Error.None);
          await expect(
      ...
      describe('to a receiver contract that reverts with message', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTM3525XReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.RevertWithMessage);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.revertedWith('CTM3525XReceiverMock: reverting');
        });
      ...
      describe('to a receiver contract that reverts without message', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTM3525XReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.RevertWithoutMessage);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.reverted;
        });
      ...
      describe('to a receiver contract that panics', function () {
        it('reverts', async function () {
          this.toOwner = await this.CTM3525XReceiverMockFactory.deploy(RECEIVER_MAGIC_VALUE, Error.Panic);
          await expect(
            this.token.connect(this.fromOwner)['transferFrom(uint256,address,uint256)'](this.fromTokenId, this.toOwner.address, transferValue)
          ).to.revertedWithPanic;
        });
    ...
    describe('approve value', function () {
      ...
      context('when the address that receives the allowance is the owner', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525X: approval to current owner');
        });
      });
      ...
      context('when the sender does not own the given token ID', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525X: approve caller is not owner nor approved');
        });
      });
      ...
      context('when then given token ID does not exist', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525X: invalid token ID');
        });
      });
      ...
      context('when set allowance to the zero address', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525X: approve value to the zero address');
        });
      });
  ...
  describe('_mint', function () {
    it('reverts with an invalid token ID', async function () {
      ...
      ).to.revertedWith('CTM3525X: cannot mint zero tokenId');
    });
    ...
    context('with minted tokens', function () {
      ...
      context('with burnt token', function () {
        ...
        it('deletes the token', async function () {
          ...
          await expect(this.token.ownerOf(firstTokenId)).to.revertedWith('CTM3525X: invalid token ID');
          await expect(this.token.slotOf(firstTokenId)).to.revertedWith('CTM3525X: invalid token ID');
          await expect(this.token.getApproved(firstTokenId)).to.revertedWith('CTM3525X: invalid token ID');
          await expect(this.token.allowance(firstTokenId, valueApproved.address)).to.revertedWith('CTM3525X: invalid token ID');
        });
  ...
  describe('_burnValue', function () {
    ...
    context('with minted tokens', function () {
      ...
      it('reverts when burn value exceeds balance', async function () {
        ...
        ).to.revertedWith('CTM3525X: burn value exceeds balance');
      });
    });
  });
}

function shouldBehaveLikeCTM3525XMetadata (errorPrefix) {
  shouldSupportInterfaces([
    'ERC721Metadata',
    'CTM3525XMetadata'
  ]);
...
function shouldBehaveLikeCTM3525XSlotEnumerable (errorPrefix) {
  shouldSupportInterfaces([
    'CTM3525XSlotEnumerable'
  ]);
  ...
  context('with minted tokens', function () {
    ...
    describe('slot by index', function () {
      ...
      it('reverts if index is greater than slot count', async function () {
        ...
        ).to.revertedWith('CTM3525XSlotEnumerable: slot index out of bounds')
      });
    });
    ...
    describe('tokenInSlotByIndex', function () {
      ...
      context('when the given index is greater than or equal to the total tokens in the given slot', function () {
        it('reverts', async function () {
          ...
          ).to.revertedWith('CTM3525XSlotEnumerable: slot token index out of bounds');
        });
      });
...
function shouldBehaveLikeCTM3525XSlotApprovable (errorPrefix) {
  shouldSupportInterfaces([
    'CTM3525XSlotApprovable',
  ]);
  ...
  describe('setApprovalForSlot', function () {
      ...
      context('after being set as slot operator', function () {
        ...
        context('when approving tokens by the slot operator', function () {
          ...
          it('reverts when approving others tokens in the same slot', async function () {
            ...
            ).to.revertedWith('CTM3525X: approve caller is not owner nor approved for all/slot');
          });
        ...
        context('when transferring tokens by the slot operator', function () {
          ...
          it('reverts when transferring others tokens in the same slot', async function () {
            ...
            ).to.revertedWith('CTM3525X: transfer caller is not owner nor approved');
          });
    ...
    context('when slot operator is the owner', function () {
      it('reverts', async function () {
        ...
        ).to.revertedWith('CTM3525XSlotApprovable: approve to owner');
      });
    });
    ...
    context('when slot operator is set not by the owner', function () {
      ...
      it('reverts when set by token approved user', async function () {
        ...
        ).to.revertedWith('CTM3525XSlotApprovable: caller is not owner nor approved for all');
      });
...
module.exports = {
  shouldBehaveLikeCTM3525X,
  shouldBehaveLikeCTM3525XMetadata,
  shouldBehaveLikeCTM3525XSlotEnumerable,
  shouldBehaveLikeCTM3525XSlotApprovable
}
