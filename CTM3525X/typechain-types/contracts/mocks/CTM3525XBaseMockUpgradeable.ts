...
export interface CTM3525XBaseMockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XBaseMockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XBaseMockUpgradeableInterface;
