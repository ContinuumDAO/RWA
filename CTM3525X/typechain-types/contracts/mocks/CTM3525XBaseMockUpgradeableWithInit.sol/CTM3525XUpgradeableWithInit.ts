...
export interface CTM3525XUpgradeableWithInitInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XUpgradeableWithInitInterface;
