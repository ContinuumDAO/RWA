...
export interface CTM3525XMetadataDescriptorUpgradeableWithInitInterface
...
export interface CTM3525XMetadataDescriptorUpgradeableWithInit
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XMetadataDescriptorUpgradeableWithInitInterface;
