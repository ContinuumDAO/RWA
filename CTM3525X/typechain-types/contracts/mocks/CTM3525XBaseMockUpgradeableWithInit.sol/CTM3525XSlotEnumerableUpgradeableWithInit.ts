...
export interface CTM3525XSlotEnumerableUpgradeableWithInitInterface
...
export interface CTM3525XSlotEnumerableUpgradeableWithInit
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XSlotEnumerableUpgradeableWithInitInterface;
