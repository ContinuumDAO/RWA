...
export interface CTM3525XBurnableUpgradeableWithInitInterface
...
export interface CTM3525XBurnableUpgradeableWithInit extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XBurnableUpgradeableWithInitInterface;
