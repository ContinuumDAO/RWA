...
export interface CTM3525XAllRoundMockUpgradeableInterface
...
export interface CTM3525XAllRoundMockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XAllRoundMockUpgradeableInterface;
