...
export interface CTM3525XMintableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XMintable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XMintableInterface;
