...
export interface CTM3525XBurnableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XBurnableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XBurnableUpgradeableInterface;
