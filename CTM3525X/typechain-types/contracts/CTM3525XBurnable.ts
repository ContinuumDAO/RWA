...
export interface CTM3525XBurnableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XBurnable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XBurnableInterface;
