...
export interface CTM3525XSlotEnumerableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XSlotEnumerable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XSlotEnumerableInterface;
