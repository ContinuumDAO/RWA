...
export interface CTM3525XMetadataDescriptorInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XMetadataDescriptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XMetadataDescriptorInterface;
