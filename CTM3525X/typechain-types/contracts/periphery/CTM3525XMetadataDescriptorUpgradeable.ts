...
export interface CTM3525XMetadataDescriptorUpgradeableInterface
...
export interface CTM3525XMetadataDescriptorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XMetadataDescriptorUpgradeableInterface;
