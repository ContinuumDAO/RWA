...
export interface ICTM3525XMetadataDescriptorInterface extends utils.Interface {
  functions: {
...
export interface ICTM3525XMetadataDescriptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICTM3525XMetadataDescriptorInterface;
