...
export interface CTM3525XSlotApprovableInterface extends utils.Interface {
  functions: {
...
export interface CTM3525XSlotApprovable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTM3525XSlotApprovableInterface;
